        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-balance leading-[1.1]">
              İş dünyasını <span className="text-neon">daha erişilebilir</span> hale getiriyoruz
            </h1>

            <p className="text-xl text-muted-foreground text-pretty leading-relaxed max-w-3xl mx-auto">
              Mesai, iş arayanlar ve işverenler arasındaki engelleri kaldırarak, herkesin esnek ve güvenli bir şekilde
              çalışmasını sağlayan bir platformdur.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <Card className="p-8 border-border/50 bg-card/50 backdrop-blur-sm">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  İş arayanlar ve işverenler arasında güvenli, hızlı ve şeffaf bir köprü kurmak. Teknoloji ile iş
                  dünyasını demokratikleştirerek, herkesin kendi şartlarında çalışmasını sağlamak.
                </p>
              </div>
            </Card>
            ...
            <Card className="p-8 border-border/50 bg-card/50 backdrop-blur-sm">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Türkiye'nin en güvenilir ve kullanıcı dostu iş bulma platformu olmak. Milyonlarca insanın hayatına
                  dokunarak, iş dünyasında yeni bir standart oluşturmak.
                </p>
              </div>
            </Card>
          </div>
      ...
      <section className="py-20 sm:py-32 border-t border-border/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold tracking-tight mb-4">Değerlerimiz</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
              Mesai'yi oluşturan temel prensipler
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                icon: Award,
                title: "Güvenilirlik",
                description: "Şeffaf ve güvenli bir platform sunarak güven inşa ediyoruz.",
              },
              {
                icon: TrendingUp,
                title: "Sürekli Gelişim",
                description: "Teknoloji ve kullanıcı deneyimini sürekli iyileştiriyoruz.",
              },
              {
                icon: Heart,
                title: "Toplumsal Fayda",
                description: "İş dünyasını daha erişilebilir hale getirerek topluma katkı sağlıyoruz.",
              },
              {
                icon: Lightbulb,
                title: "İnovasyon",
                description: "Yenilikçi çözümlerle iş bulma deneyimini yeniden tanımlıyoruz.",
              },
              {
                icon: Target,
                title: "Sonuç Odaklı",
                description: "Kullanıcılarımızın başarısı bizim başarımızdır.",
              },
            ].map((value, i) => (
              <Card
                key={i}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              ...
              { value: "500+", label: "Kayıtlı İşveren" },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="relative overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm">
            ...
            <div className="relative p-12 sm:p-16 text-center space-y-8">
              <h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-balance">Bize katılın</h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
                Mesai ailesinin bir parçası olun ve iş dünyasında fark yaratın.
              </p>
